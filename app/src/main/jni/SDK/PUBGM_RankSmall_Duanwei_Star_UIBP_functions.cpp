...
// (NetReliable, Native, Event, NetResponse, Static, NetMulticast, MulticastDelegate, Public, Protected, HasOutParms, HasDefaults)
// Parameters:
...
void URankSmall_Duanwei_Star_UIBP_C::STATIC_SetRankIntegral(const struct FBP_STRUCT_RankIntegralLevel_type& RankIntegralLevel_Info, bool isStarOpen)
{
...
// (Native, Event, NetResponse, Static, NetMulticast, MulticastDelegate, Public, Protected, HasOutParms, HasDefaults)
// Parameters:
...
void URankSmall_Duanwei_Star_UIBP_C::STATIC_SetRankText(const struct FSlateColor& Color, const struct FSlateColor& ShadowColor, const struct FSlateFontInfo& FontInfo)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
...
// (Net, NetReliable, Exec, Native, Event, NetResponse, Static, Protected, Delegate, NetServer)
// Parameters:
