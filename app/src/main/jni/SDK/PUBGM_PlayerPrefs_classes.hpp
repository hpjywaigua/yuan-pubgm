...
public:
	...
	void STATIC_SetDecomposeIndexTriggerTime(int TimeStamp);
	void STATIC_SetClickTimeAnniversary(const struct FString& UID, int Time);
	void STATIC_GetClickTimeAnniversary(const struct FString& UID, int* Value);
	void STATIC_GetCliickVehicleAcitivtyGuideExchange(const struct FString& Key, bool* hasClick);
	void STATIC_SetCliickVehicleAcitivtyGuideExchange(const struct FString& Key, bool isClick);
	void STATIC_SetClickTimeIceLucky(int Time, const struct FString& UUID);
	void STATIC_GetClickTimeIceLucky(const struct FString& UUID, int* Value);
	void STATIC_SetIsVNGAdult();
	void STATIC_SetHasClickHalloweenExchange(bool isClick, const struct FString& UUID);
	void STATIC_GetHasClickHalloweenExchange(const struct FString& UUID, bool* hasClick);
