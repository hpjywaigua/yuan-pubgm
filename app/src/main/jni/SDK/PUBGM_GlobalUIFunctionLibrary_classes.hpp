...
public:
	...
	void STATIC_GetZoneDelay(int ZoneID, int fakeShowDelay, int maxDelay, class UObject* __WorldContext, int* Delay);
	void STATIC_UnixTimeToLocalizedTimeStrGMT(int Year, int Month, int Day, int Hour, int Min, int sec, bool start_from_month, const struct FString& h_m_s_format, class UObject* __WorldContext, struct FString* TimeStr);
	...
	void STATIC_SetAndroidKeyIsValid(bool bValid, class UObject* __WorldContext);
	void numToTimeStrFormat(int timeNum, class UObject* __WorldContext, struct FString* TimeStr);
	void STATIC_numToTimeStr(int timeNum, class UObject* __WorldContext, struct FString* TimeStr);
	void STATIC_IdToColor(int ID, class UObject* __WorldContext, struct FColor* Color);
	...
	void STATIC_SetIntimacy(class UImage* heart, int intimacynum, class UTextBlock* intimacyText, class UObject* __WorldContext);
	void STATIC_GetLobbyRankTexture(int rankIntegral, class UObject* __WorldContext, class UTexture2D** Output);
	void STATIC_SetScenePointLightProperty(const struct FString& lightName, const struct FTransform& targetTrans, float Intensity, const struct FLinearColor& Color, int inverseSquareFalloff, float Radius, class UObject* __WorldContext);
	void STATIC_SetSceneDirectionalLightProperty(const struct FString& lightName, const struct FTransform& targetTrans, float Intensity, const struct FLinearColor& Color, class UObject* __WorldContext);
	...
	void STATIC_GetLobbyCorpsIcon(int IconID, class UObject* __WorldContext, class UTexture2D** Value);
	...
	void GetGvoiceInterface(class UObject* __WorldContext, class UVoiceSDKInterface** outputObj);
	...
	void STATIC_PlaySoundClickButton(class UObject* __WorldContext);
