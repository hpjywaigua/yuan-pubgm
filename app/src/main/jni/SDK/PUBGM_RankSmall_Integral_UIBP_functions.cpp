...
// (Native, Event, NetResponse, Static, Private, Protected, HasDefaults, NetClient, DLLImport, BlueprintCallable, BlueprintPure)
// Parameters:
...
// (Net, NetRequest, Exec, Native, NetResponse, Static, Protected, Delegate, NetServer)
// Parameters:
