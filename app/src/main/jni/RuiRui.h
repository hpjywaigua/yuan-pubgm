...
namespace ImRuiRui
{
      ...
      ---------------------------------------------------------------
        ...
        ImGui::PushStyleColor(ImGuiCol_Border, ImRuiRui::Rainbow(s0));
      ---------------------------------------------------------------
      ...
      */
      ...
      /*---------------------------------------------------------------------------------------------------------
                                                        主题                                                 */
        void REDFIRE_Yellow(ImGuiStyle* dst = NULL)  
      {  
      ImGuiStyle *style = &ImGui::GetStyle();
		...
		style->WindowPadding = ImVec2(5,2);
    ...
    colors[ImGuiCol_Border]                 = ImColor(208, 171, 54, 255);
    ...
    colors[ImGuiCol_TitleBg]                = ImColor(208, 171, 54, 155);
    colors[ImGuiCol_TitleBgActive]          = ImColor(208, 171, 54, 155);
    colors[ImGuiCol_TitleBgCollapsed]       = ImColor(208, 171, 54, 155);
    colors[ImGuiCol_MenuBarBg]              = ImColor(0, 0, 0, 0);
    colors[ImGuiCol_ScrollbarBg]            = ImColor(208, 171, 54, 155);
    colors[ImGuiCol_ScrollbarGrab]          = ImColor(255, 255, 255, 155);
    colors[ImGuiCol_ScrollbarGrabHovered]   = ImColor(255, 255, 255, 155);
    colors[ImGuiCol_ScrollbarGrabActive]    = ImColor(255, 255, 255, 155);
    colors[ImGuiCol_CheckMark]              = ImColor(208, 171, 54, 255);
